...
import kotlinx.android.synthetic.main.adapter_timeline_center_right_item.view.*

class TimelineCenterRightViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
