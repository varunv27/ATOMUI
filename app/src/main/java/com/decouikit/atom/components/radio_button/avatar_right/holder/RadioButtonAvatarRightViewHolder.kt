package com.decouikit.atom.components.radio_button.avatar_right.holder
...
class RadioButtonAvatarRightViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
