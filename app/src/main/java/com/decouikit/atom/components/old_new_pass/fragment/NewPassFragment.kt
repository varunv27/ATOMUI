package com.decouikit.atom.components.old_new_pass.fragment
...
class NewPassFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        loadView(inflater.inflate(R.layout.fragment_new_pass, container, false))
    ...
    override fun onClick(v: View?) {
        when (v) {
            viewLayout.btnLogin -> {
                Toast.makeText(viewLayout.context, R.string.reset_pass, Toast.LENGTH_SHORT).show()
            }
    ...
    companion object {
        fun newInstance(): NewPassFragment {
            return NewPassFragment()
        }
    }
}