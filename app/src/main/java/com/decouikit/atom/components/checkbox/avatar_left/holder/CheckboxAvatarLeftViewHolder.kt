package com.decouikit.atom.components.checkbox.avatar_left.holder

import android.view.View
import androidx.core.content.ContextCompat
import androidx.recyclerview.widget.RecyclerView
import com.decouikit.atom.components.checkbox.avatar_left.model.CheckBoxItem
import kotlinx.android.synthetic.main.adapter_checkbox_image_left.view.*

class CheckboxAvatarLeftViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
