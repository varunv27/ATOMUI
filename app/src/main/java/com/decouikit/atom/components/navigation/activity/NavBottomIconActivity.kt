...
import kotlinx.android.synthetic.main.acitivty_bottom_navigation_icon.*

class NavBottomIconActivity : AppCompatActivity(), BottomNavigationView.OnNavigationItemSelectedListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.acitivty_bottom_navigation_icon)
