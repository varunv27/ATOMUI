...
import kotlinx.android.synthetic.main.activity_top_navigation_text.*

class NavTopTextActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_top_navigation_text)
