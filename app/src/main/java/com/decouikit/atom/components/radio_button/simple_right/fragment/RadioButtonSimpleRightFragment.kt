package com.decouikit.atom.components.radio_button.simple_right.fragment
...
import com.decouikit.atom.components.radio_button.simple_right.adapter.RadioButtonSimpleRightAdapter
...
class RadioButtonSimpleRightFragment : Fragment() {

    private lateinit var viewLayout: View
    private lateinit var items: ArrayList<RadioButtonItem>
    private lateinit var adapter: RadioButtonSimpleRightAdapter
    ...
    private fun loadView(view: View) {
        viewLayout = view
        adapter = RadioButtonSimpleRightAdapter(items)
    ...
    companion object {
        ...
        fun newInstance(list: ArrayList<RadioButtonItem>): RadioButtonSimpleRightFragment {
            val fragment = RadioButtonSimpleRightFragment()
            val args = Bundle()
