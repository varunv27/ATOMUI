package com.decouikit.atom.components.radio_button.avatar_left.fragment
...
import com.decouikit.atom.components.radio_button.avatar_left.adapter.RadioButtonAvatarLeftAdapter
...
class RadioButtonAvatarLeftFragment : Fragment() {

    private lateinit var viewLayout: View
    private lateinit var items: ArrayList<RadioButtonItem>
    private lateinit var adapter: RadioButtonAvatarLeftAdapter
    ...
    private fun loadView(view: View) {
        viewLayout = view
        adapter = RadioButtonAvatarLeftAdapter(items)
    ...
    companion object {
        ...
        fun newInstance(list: ArrayList<RadioButtonItem>): RadioButtonAvatarLeftFragment {
            val fragment = RadioButtonAvatarLeftFragment()
            val args = Bundle()
